    ...
    @extend_schema(
        parameters=[
            OpenApiParameter(
                ...
                description="Filter movie by title (ex. ?title=Inception)",
            ),
            OpenApiParameter(
                "genres",
                type={"type": "array", "items": {"type": "number"}},
                description="Filter movie by genre id (ex. ?genres=2,3)",
            ),
            OpenApiParameter(
                "actors",
                type={"type": "array", "items": {"type": "number"}},
                description="Filter movie by actor id (ex. ?actors=4,5)",
            ),
        ]
    )
