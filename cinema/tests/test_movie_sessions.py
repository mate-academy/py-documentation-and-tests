...
from cinema.models import MovieSession, Movie, CinemaHall, Genre, Actor
from cinema.serializers import MovieSessionSerializer, MovieSessionListSerializer, MovieSessionDetailSerializer
...
def sample_movie_session(**params) -> MovieSession:
    ...
    genre2 = Genre.objects.create(name="Roman")

    actor1 = Actor.objects.create(first_name="Carp", last_name="Smith")
    actor2 = Actor.objects.create(first_name="Petr", last_name="Rym")
