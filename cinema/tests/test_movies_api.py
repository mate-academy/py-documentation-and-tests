...
class AuthenticatedMovieApiTest(TestCase):
    ...
    def test_movie_list(self):
        movie = sample_movie()
        actor = sample_actor(first_name="King", last_name="Kong")
    ...
    def test_filter_movie_by_title(self):
        ...
        response = self.client.get(MOVIE_URL, {'title': movie.title})
    ...
    def test_filter_movie_by_actor(self):
        movie = sample_movie()
        movie1 = sample_movie()
        actor = sample_actor(first_name="Bob", last_name="White")
        movie.actors.add(actor)
    ...
    def test_retrieve_movie_detail(self):
        movie = sample_movie()
        movie.actors.add(sample_actor(first_name="Bob", last_name="White"))
