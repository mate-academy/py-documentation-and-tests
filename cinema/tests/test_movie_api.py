...
class AuthenticatedMovieAPITests(TestCase):
    ...
    def test_movies_filter_by_title(self):
        ...
        serializer_movie_1 = MovieListSerializer(self.movie)
        serializer_movie_2 = MovieListSerializer(self.movie2)
    ...
    def test_movies_filter_by_genre(self):
        ...
        serializer_movie_1 = MovieListSerializer(movie_without_genre)
        serializer_movie_2 = MovieListSerializer(movie_with_genre)
    ...
    def test_movies_filter_by_actor(self):
        ...
        movie_actor = sample_actor()
        movie_with_actors_1.actors.add(self.actor)
        movie_with_actors_2.actors.add(movie_actor)

        res = self.client.get(MOVIE_URL, {"actors": f"{self.genre.id}, {movie_actor.id}"})

        serializer_movie_1 = MovieListSerializer(movie_without_actors)
        serializer_movie_2 = MovieListSerializer(movie_with_actors_1)
        serializer_movie_3 = MovieListSerializer(movie_with_actors_2)
