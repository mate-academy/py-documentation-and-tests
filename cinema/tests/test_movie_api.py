...
class AuthenticatedMovieApiTests(TestCase):
    ...
    def test_retrieve_movie_detail(self):
        ...
        movie.actors.add(Actor.objects.create(first_name="test", last_name="actor"))
    ...
    def test_update_movie_forbidden(self):
        ...
        res = self.client.patch(MOVIE_URL, payload)
        self.assertEqual(res.status_code, status.HTTP_403_FORBIDDEN)
...
class AdminMovieApiTests(TestCase):
    ...
    def test_create_movie_with_actors_and_genres(self):
        genre = sample_genre(name="testgenre")
        actor = sample_actor(first_name="testactor", last_name="test")
        payload = {
            "title": "Test",
            "description": "Movie about...",
            "duration": 150,
