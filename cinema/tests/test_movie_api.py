...
class AuthenticatedMovieApiTests(TestCase):
    ...
    def test_movie_list(self):
        sample_movie()
        movie = sample_movie(title="Sample 1")
        ...
        actor_2 = sample_actor(first_name="Matt", last_name="Damon")
    ...
    def test_filter_movies_by_genres(self):
        ...
        movie_with_genre_1 = sample_movie(title="Sample 1")
        movie_with_genre_2 = sample_movie(title="Sample 2")
    ...
    def test_filter_movies_by_actors(self):
        ...
        movie_with_actor_1 = sample_movie(title="Sample 1")
        movie_with_actor_2 = sample_movie(title="Sample 2")
    ...
    def test_create_movie_forbidden(self):
        payload = {"title": "Test 1", "description": "Testing", "duration": "90"}
