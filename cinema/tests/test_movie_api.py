...
class AuthenticatedMovieApiTest(TestCase):
    ...
    def test_list_movie(self):
        sample_movie()
        movie_with_genres = sample_movie(title="Test Genres")
        movie_with_actors = sample_movie(title="Test actors")

        genre1 = sample_genre()
        genre2 = sample_genre(name="Horror")

        actor1 = sample_actor()
        actor2 = sample_actor(first_name="Max")
    ...
    def test_filter_movies_by_title(self):
        movie1 = sample_movie(title="Winter")
        movie2 = sample_movie(title="Winter2")
        movie3 = sample_movie(title="movie3")

        response = self.client.get(MOVIE_URL, {"title": f"winter"})
    ...
    def test_retrieve_movie_detail(self):
        movie = sample_movie()
        movie.actors.add(sample_actor().id, sample_actor(first_name="Kate").id)
