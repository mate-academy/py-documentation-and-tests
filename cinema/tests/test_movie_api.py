...
class AuthenticatedMovieApiTests(TestCase):
    ...
    def test_filter_movies_by_title(self):
        movie_a = sample_movie(title="A")
        movie_b = sample_movie(title="B")

        result = self.client.get(MOVIE_URL, {"title": "A"})

        serializer1 = MovieListSerializer(movie_a)
        serializer2 = MovieListSerializer(movie_b)

        self.assertIn(serializer1.data, result.data)
        self.assertNotIn(serializer2, result.data)
    ...
    def test_create_forbedden(self):
        movie_data = {
            "title": "Sample movie",
            "description": "Sample description",
            "duration": 90,
        ...
        result = self.client.post(MOVIE_URL, data=movie_data)
...
class AdminMovieApiTests(TestCase):
    ...
    def test_create_movie(self):
        ...
        result = self.client.post(MOVIE_URL, movie_data)
