...
def sample_movie(**params):
    defaults = {"title": "Good movie", "description": "Good description", "duration": 90}
...
def sample_actor(**params):
    defaults = {"first_name": "Jim", "last_name": "Carrey"}
    defaults.update(params)
...
def sample_movie_session(**params):
    ...
    defaults = {"show_time": "2022-07-21 12:00:00", "movie": None, "cinema_hall": cinema_hall}
    defaults.update(params)
...
class MovieImageUploadTests(TestCase):
    ...
    def setUp(self):
        ...
        self.user = get_user_model().objects.create_superuser("admin@admin.com", "password")
...
class AuthenticatedMovieApiTests(TestCase):
    ...
    def test_movies_by_title(self):
        ...
        movie2 = sample_movie(title="empty")
    ...
    def test_create_movie_forbidden(self):
        payload = {"title": "good_movie", "description": "good_description", "duration": 120}
        res = self.client.post(MOVIE_URL, payload=payload)
...
class AdminMovieApiTests(TestCase):
    ...
    def test_create_movie(self):
        actor = sample_actor()
        genre = sample_genre()
        payload = {"title": "good_movie", "description": "good_description", "duration": 120, "actors": actor.id, "genres": genre.id}
