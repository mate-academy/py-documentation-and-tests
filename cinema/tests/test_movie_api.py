...
class AuthenticatedMovieApiTests(TestCase):
    ...
    def test_list_movies(self):
        sample_movie()
        movie_with_genres = sample_movie(title="Looped")
        movie_with_actors = sample_movie(title="Inception")
    ...
    def test_filter_movies_by_genres(self):
        movie1 = sample_movie()
        movie2 = sample_movie(title="Looped")
        movie3 = sample_movie(title="Without genre")
    ...
    def test_filter_movies_by_title(self):
        movie1 = sample_movie()
        movie2 = sample_movie(title="Looped")
        movie3 = sample_movie(title="Without title")

        res1 = self.client.get(MOVIE_URL, {"title": "looped"})
        res2 = self.client.get(MOVIE_URL, {"title": "Sample movie"})
