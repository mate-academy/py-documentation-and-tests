...
class AuthenticatedMovieApiTests(TestCase):
    ...
    def test_movie_list(self):
        ...
        test_genre_1 = sample_genre()
        test_genre_2 = sample_genre(name="Test Genre")

        test_actor_1 = sample_actor()
        test_actor_2 = sample_actor(
            first_name="Test First Name",
            last_name="Test Last Name"
        )

        movie_with_genres_and_actors.genres.add(test_genre_1, test_genre_2)
        movie_with_genres_and_actors.actors.add(test_actor_1, test_actor_2)
    ...
    def test_filter_movies_by_title(self):
        movie_with_title_1 = sample_movie()
        movie_with_title_2 = sample_movie(title="Test Movie")
        res = self.client.get(
            MOVIE_URL,
        ...
        self.assertEqual(res.status_code, status.HTTP_200_OK)
        self.assertIn(serializer_movie_title_1.data, res.data["results"])
        self.assertIn(serializer_movie_title_2.data, res.data["results"])

    def test_filter_movies_by_genres(self):
        movie_without_genres = sample_movie()
        movie_with_genre_1 = sample_movie()
        movie_with_genre_2 = sample_movie(title="Test Movie")

        genre_1 = sample_genre()
        genre_2 = sample_genre(name="Test Genre")
        ...
        self.assertIn(serializer_movie_genres_1.data, res.data["results"])
        self.assertIn(serializer_movie_genres_2.data, res.data["results"])

    def test_filter_movies_by_actors(self):
        movie_without_actors = sample_movie()
        movie_with_actor_1 = sample_movie()
        movie_with_actor_2 = sample_movie(title="Test Movie")
        ...
        self.assertIn(serializer_movie_actors_1.data, res.data["results"])
        self.assertIn(serializer_movie_actors_2.data, res.data["results"])
...
class AdminMovieApiTests(TestCase):
    ...
    def test_update_movie_not_allowed(self):
        ...
        res_put = self.client.put(url, {"title": "Test Movie"})
