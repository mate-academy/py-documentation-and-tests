...
class AuthenticatedMovieApiTests(TestCase):
    ...
    def test_movies_list(self):
        ...
        actor1 = sample_actor(first_name="Test", last_name="Testovenko")
        actor2 = sample_actor(first_name="Test", last_name="Testovich")
    ...
    def test_filter_movies_by_genres(self):
        ...
        movie_without_genre = sample_movie(title="Movie 3")
