...
class AuthenticatedMovieTests(TestCase):
    ...
    def test_filter_movies_by_genre(self):
        ...
        genre2 = Genre.objects.create(name="Historic")
    ...
    def test_filter_movies_by_actor(self):
        ...
        actor1 = Actor.objects.create(first_name="Ivan", last_name="Ivanov")
        actor2 = Actor.objects.create(first_name="Petro", last_name="Petrov")
