...
class UnauthenticatedMovie(TestCase):
    def setUp(self):
        self.client = APIClient()
...
class AuthenticationMovieApiTest(TestCase):
    def setUp(self):
        self.client = APIClient()
    ...
    def test_list_movies(self):
        actor1 = sample_actor()
        actor2 = sample_actor()
        genre1 = sample_genre(name="Biography")
        genre2 = sample_genre()
        movie1 = sample_movie()
        movie2 = sample_movie()
    ...
    def test_filter_movies_by_actors(self):
        actor1 = sample_actor(first_name="Petro", last_name="Petrov")
        actor2 = sample_actor()
        genre = sample_genre()
        movie1 = sample_movie()
        movie2 = sample_movie()
    ...
    def test_filter_movies_by_title(self):
        actor = sample_actor()
        genre = sample_genre()
        movie1 = sample_movie(title="Super puper")
        movie2 = sample_movie()
        movie1.actors.add(actor)
        movie1.genres.add(genre)
        movie2.actors.add(actor)
        ...
        res = self.client.get(MOVIE_URL, {"title": "Super puper"})
