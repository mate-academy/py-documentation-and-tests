...
class AuthenticatedMovieApiTests(TestCase):
    ...
    def test_movie_list_filter_by_title(self):
        movie1 = sample_movie(title="MovieTest1")
        movie2 = sample_movie(title="MovieTest2")
        movie3 = sample_movie(title="MovieTest20")
    ...
    def test_movie_list_filter_by_genres(self):
        movie1 = sample_movie(title="MovieTest1")
        movie2 = sample_movie(title="MovieTest2")
        movie3 = sample_movie(title="MovieTest3")
    ...
    def test_movie_list_filter_by_actors(self):
        movie1 = sample_movie(title="MovieTest1")
        movie2 = sample_movie(title="MovieTest2")
        movie3 = sample_movie(title="MovieTest21")
