...
class AuthenticatedMovieApiTests(TestCase):
    ...
    def test_filter_movies_by_actors(self):
        ...
        actor1 = sample_actor(first_name="First", last_name="Actor")
        actor2 = sample_actor(first_name="Second", last_name="Actor")
...
class AdminMovieApiTests(TestCase):
    ...
    def test_create_bus_with_actors_and_genres(self):
        actor1 = sample_actor(first_name="First", last_name="Actor")
        actor2 = sample_actor(first_name="Second", last_name="Actor")
        genre1 = sample_genre(name="First")
        genre2 = sample_genre(name="Second")
    ...
    def test_movie_put_patch_not_allowed(self):
        movie = sample_movie()
        url = detail_url(movie.id)
