...
class AuthenticatedMovieApiTests(TestCase):
    ...
    def test_filter_movies(self):
        ...
        movie_with_genre = sample_movie(title="Movie 1")
        ...
        responses = [
            ...
            self.client.get(MOVIE_URL, {"title": "tes"}),
        ]
...
class AdminMovieApiTests(TestCase):
    ...
    def test_create_movie(self):
        ...
        self.assertEqual(movie.genres.all()[0].id, 1)
        self.assertEqual(movie.actors.all()[0].id, 1)
