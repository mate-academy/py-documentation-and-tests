...
class AuthenticatedMovieApiTests(TestCase):
    ...
    def test_list_movies(self) -> None:
        ...
        movie_with_genre_and_actor.genres.add(genre1, genre2)
        movie_with_genre_and_actor.actors.add(actor1, actor2)
    ...
    def test_filter_movies_by_genres(self) -> None:
        movie1 = sample_movie(title="test_movie_1")
        movie2 = sample_movie(title="test_movie_2")
        ...
        movie3 = sample_movie(title="test_movie_without_genres")
    ...
    def test_filter_movies_by_actors(self) -> None:
        ...
        movie3 = sample_movie(title="test_movie_without_actors")
