...
class UnauthenticatedMovieApiTests(TestCase):
    ...
    def test_auth_required(self):
        """Test that unauthenticated user don't have permission to MOVIE_URL"""
        res = self.client.get(MOVIE_URL)
...
class AuthenticatedMovieApiTests(TestCase):
    ...
    def test_list_movies(self):
        ...
        actor1 = sample_actor()
        actor2 = sample_actor(first_name="Rayon", last_name="Reynolds")
    ...
    def test_filter_movies_by_actors(self):
        movie_with_actors = sample_movie(
            title="Bullet train",
            description="Five assassin abroad a swiftly-moving bullet train find out that their missions have "
                        "something in common",
            duration=127
        )

        actor1 = sample_actor()
        actor2 = sample_actor(first_name="Bread", last_name="Pitt")
