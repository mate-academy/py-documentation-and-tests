...
class AuthenticatedMovieApiTests(TestCase):
    ...
    def test_list_movies(self):
        ...
        genre1 = sample_genre()
        genre2 = sample_genre(name="Musical")

        actor1 = sample_actor()
        actor2 = sample_actor(first_name="New", last_name="Actor")
    ...
    def test_filter_movies_by_genres(self):
        ...
        genre1 = sample_genre()
        genre2 = sample_genre(name="Somegenre")
    ...
    def test_filter_movies_by_actors(self):
        ...
        actor1 = sample_actor()
        actor2 = sample_actor(first_name="Best", last_name="Actor")
