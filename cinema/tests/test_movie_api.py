...
class AuthenticatedMovieApiTests(TestCase):
    ...
    def test_filter_movies_by_genre(self):
        movie1 = sample_movie(title="Title 1")
        movie2 = sample_movie(title="Title 2")
    ...
    def test_filter_movies_by_actors(self):
        ...
        actor_john = sample_actor(first_name="John", last_name="Smith")
        actor_bob = sample_actor(first_name="Bob", last_name="White")

        movie1.actors.add(actor_john)
        movie2.actors.add(actor_bob)

        res = self.client.get(MOVIE_URL, {"actors": f"{actor_john.id},{actor_bob.id}"})
