...
class AuthenticatedBusApiTests(TestCase):
    ...
    def test_filter_movies_by_actors(self):
        ...
        actor1 = Actor.objects.create(first_name="Bruce", last_name="Willis")
        actor2 = Actor.objects.create(
            first_name="Leonardo", last_name="Dicaprio"
        )

        genre1 = Genre.objects.create(name="ActionTest")
        genre2 = Genre.objects.create(name="ActionTest2")
    ...
    def test_retrieve(self):
        movie = sample_movie()
        movie.actors.add(
            Actor.objects.create(first_name="Bruce", last_name="Willis")
        )
...
class AdminMovieApiTest(TestCase):
    def setUp(self):
        self.client = APIClient()
        self.user = get_user_model().objects.create_user(
            "admine@test.com", "testpass", is_staff=True
        )
        self.client.force_authenticate(self.user)
    ...
    def test_create_movie_with_genres_and_actors(self):
        actor1 = Actor.objects.create(
            first_name="testBruce", last_name="testWillis"
        )
        actor2 = Actor.objects.create(
            first_name="testLeonardo", last_name="testDicaprio"
        )
        genre = Genre.objects.create(name="testAction")
