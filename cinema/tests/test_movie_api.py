...
class AuthenticatedMovieApiTests(TestCase):
    def setUp(self):
        self.client = APIClient()
        self.user = get_user_model().objects.create_superuser(
            email="testmail@gmail.com", password="Testpassword"
        )
        self.client.force_authenticate(self.user)
    ...
    def test_filter_movies(self):
        ...
        self.assertIn(MovieListSerializer(movie1).data, response.data)
        self.assertNotIn(MovieListSerializer(movie2).data, response.data)
    ...
    def test_create_movie_success(self):
        ...
        actor = sample_actor(first_name='Actor1', last_name='Lastname1')
        payload = {
            "title": "movie1",
            "description": "description",
            "duration": 120,
