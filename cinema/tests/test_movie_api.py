...
class AuthenticatedMovieApiTests(TestCase):
    ...
    def test_list_buses(self):
        ...
        movie_with_genre_and_actor.genres.add(genre1)
        movie_with_genre_and_actor.actors.add(actor1)
    ...
    def test_list_filter_movies_by_title(self):
        movie1 = sample_movie(title="Test_title1")
        movie2 = sample_movie(title="Test_title2")
    ...
    def test_list_filter_movies_by_genre(self):
        movie1 = sample_movie(title="Test_title1")
        movie2 = sample_movie(title="Test_title2")
        movie3 = sample_movie(title="Movie without filter")
    ...
    def test_list_filter_movies_by_actor(self):
        movie1 = sample_movie(title="Test_title1")
        movie2 = sample_movie(title="Test_title2")
        movie3 = sample_movie(title="Movie without filter")
    ...
    def test_retrieve_movie_detail(self):
        movie = sample_movie(title="Test_title1")
