...
class AuthenticatedMovieApiTests(TestCase):
    def setUp(self) -> None:
        ...
        self.genre2 = sample_genre(name="Thriller")

        self.actor1 = sample_actor()
        self.actor2 = sample_actor(first_name="Matt")

    def test_list_movies(self):
        sample_movie()
        movie_with_actors_and_genres = sample_movie()

        movie_with_actors_and_genres.genres.add(self.genre1, self.genre2)
        movie_with_actors_and_genres.actors.add(self.actor1, self.actor2)
    ...
    def test_filter_movies_by_title(self):
        ...
        movie2 = sample_movie(title="Movie")
        movie3 = sample_movie()
    ...
    def test_create_movie_forbidden(self):
        payload = {"title": "Test", "description": "test description", "duration": 999}
...
class AdminMovieApiTests(TestCase):
    def setUp(self) -> None:
        ...
        self.user = get_user_model().objects.create_user(
            "admin@admin.com", "password1", is_staff=True
        )
        self.client.force_authenticate(self.user)
