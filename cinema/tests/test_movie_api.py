...
class AuthenticatedMovieApiTests(TestCase):
    ...
    def test_list_movies(self):
        ...
        actor = sample_actor(first_name="Famous", last_name="Actor")
        genre = sample_genre(name="Sample genre")
    ...
    def test_filter_movies_by_title(self):
        ...
        response = self.client.get(MOVIE_URL, {"title": movie1.title})
    ...
    def test_filter_movies_by_genres(self):
        ...
        genre1 = sample_genre(name="Sample")
        genre2 = sample_genre(name="Genre")
    ...
    def test_filter_movies_by_actors(self):
        ...
        actor2 = sample_actor(first_name="More Famous", last_name="Actor")
    ...
    def test_retrieve_movie_detail(self):
        movie = sample_movie(title="Great movie")
        actor = sample_actor(first_name="Famous", last_name="Actor")
        genre = sample_genre(name="Sample")
