...
class AuthenticatedMovieApiTests(TestCase):
    ...
    def test_filter_movie_by_title(self):
        ...
        res = self.client.get(MOVIE_URL, {"title": f"{movie1}"})
    ...
    def test_filter_movie_by_genres(self):
        ...
        res = self.client.get(MOVIE_URL, {"genres": f"{genre1.id}, {genre1.id}"})
    ...
    def test_filter_movie_by_actors(self):
        ...
        actor1 = sample_actor(first_name="actor 1", last_name="last_name 1")
        actor2 = sample_actor(first_name="actor 2", last_name="last_name 1")
    ...
    def test_retrieve_movie_detail(self):
        ...
        movie.actors.add = sample_actor(first_name="actor 1", last_name="last_name 1")
...
class AdminMovieApiTest(TestCase):
    ...
    def test_create_movie(self):
        ...
        actor = sample_actor(first_name="actor 1", last_name="last_name 1")
        payload = {
            "title": "Sample movie",
            "description": "Sample description",
            "duration": 90,
