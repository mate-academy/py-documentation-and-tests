...
class AuthenticatedMovieApiTests(TestCase):
    ...
    def test_filter_movies_by_genres(self):
        ...
        res_genre = self.client.get(MOVIE_URL, {
            "genres": f"{genre1.id}, {genre2.id}"
        })
        res_actor = self.client.get(MOVIE_URL, {
        ...
        self.assertIn(serializer1.data, res_genre.data)
        self.assertIn(serializer2.data, res_genre.data)
        self.assertNotIn(serializer3.data, res_genre.data)
        self.assertIn(serializer1.data, res_actor.data)
        self.assertIn(serializer2.data, res_actor.data)
        self.assertNotIn(serializer3.data, res_actor.data)
