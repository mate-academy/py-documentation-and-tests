...
class AuthenticatedMovieAPITests(TestCase):
    def setUp(self):
        ...
        self.user = get_user_model().objects.create_user(
            email="test@python.com", password="1qazcde3"
        )
        self.client.force_authenticate(self.user)
    ...
    def test_filter_movies_by_title(self):
        ...
        movie_3 = sample_movie(title="test title")
    ...
    def test_filter_movies_by_genres(self):
        ...
        movie_with_genre_1 = sample_movie(title="test title")
        movie_with_genre_2 = sample_movie(title="title")

        genre_1 = sample_genre(name="test genre")
        genre_2 = sample_genre(name="genre")
    ...
    def test_filter_movies_by_actors(self):
        ...
        movie_with_actor_1 = sample_movie(title="title1")
        movie_with_actor_2 = sample_movie(title="title2")

        actor_1 = sample_actor(first_name="First")
        actor_2 = sample_actor(first_name="Second")
...
class AdminMovieAPITests(TestCase):
    def setUp(self):
        self.client = APIClient()
        self.user = get_user_model().objects.create_user(
            email="admin@python.com", password="1qazcde3", is_staff=True,
        )
        self.client.force_authenticate(self.user)
    ...
    def test_create_movie_with_genres_and_actors(self):
        ...
        actor_2 = sample_actor(first_name="First")
        payload = {
            "title": "title",
            "description": "description",
            "duration": 140,
