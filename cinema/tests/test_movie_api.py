...
class AuthenticatedMovieApiTests(TestCase):
    ...
    def test_filter_movies_by_genres(self) -> None:
        ...
        movie_with_genres_1 = sample_movie(title="Inception")
        movie_with_genres_2 = sample_movie(title="Django")
    ...
    def test_filter_movies_by_actors(self) -> None:
        ...
        movie_with_actors_1 = sample_movie(title="Inception")
        movie_with_actors_2 = sample_movie(title="Django")

        actor_1 = sample_actor()
        actor_2 = sample_actor(first_name="Jack", last_name="Black")
        ...
        serializer_without_genres = MovieListSerializer(movie_without_actors)
        serializer_with_genre_1 = MovieListSerializer(movie_with_actors_1)
        serializer_with_genre_2 = MovieListSerializer(movie_with_actors_2)
