...
class AuthenticatedMovieApiTest(TestCase):
    ...
    def test_filter_movies_by_title(self):
        res = self.client.get(MOVIE_URL, {"title": f"{self.movie1.title}"})
    ...
    def test_filter_movies_by_genres(self):
        genre1 = sample_genre(name="test_genre_1")
        genre2 = sample_genre(name="test_genre_2")
    ...
    def test_filter_movies_by_actors(self):
        actor1 = sample_actor(first_name="test_actor_1")
        actor2 = sample_actor(first_name="test_actor_2")
    ...
    def test_retrieve_movie_detail(self):
        url = detail_url(movie_id=self.movie1.id)
...
class AdminMovieApiTests(TestCase):
    ...
    def test_create_movie_with_actors(self):
        actor1 = sample_actor(first_name="first")
        actor2 = sample_actor(first_name="second")
        payload = {
            "title": "Test",
            "description": "Test",
            "duration": 42,
    ...
    def test_create_movie_with_genres(self):
        ...
        genre2 = sample_genre(name="second")
        payload = {
            "title": "Test",
            "description": "Test",
            "duration": 42,
