...
def create_film_with_custom_params():
    genre = sample_genre(name="Disaster")
    actor = sample_actor(first_name="Patricia", last_name="Kats")
    movie = sample_movie(
        title="Star Guardian",
        description="about star and guardian",
        duration=77,
    )
