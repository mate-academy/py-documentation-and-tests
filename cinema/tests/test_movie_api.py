...
class AuthenticatedMovieTest(TestCase):
    ...
    def test_filter_movie_by_title(self):
        ...
        movie_2 = sample_movie(title="Matrix Reloaded")
        movie_3 = sample_movie(title="Blowing")
    ...
    def test_filter_movie_by_genres(self):
        ...
        movie_with_genre_1 = sample_movie(title="Avengers")
        movie_with_genre_2 = sample_movie(title="I, I`m and Iren")
        ...
        serializer_genre_1 = MovieListSerializer(movie_with_genre_1)
        serializer_genre_2 = MovieListSerializer(movie_with_genre_2)
    ...
    def test_filter_movie_by_actors(self):
        ...
        movie_with_actor_1 = sample_movie(title="Avengers")
        movie_with_actor_2 = sample_movie(title="I, I`m and Iren")

        actor_1 = sample_actor()
        actor_2 = sample_actor(
            first_name="Mithun",
            last_name="Chackrabortie",
        )
        ...
        serializer_actor_1 = MovieListSerializer(movie_with_actor_1)
        serializer_actor_2 = MovieListSerializer(movie_with_actor_2)
