...
class AuthenticatedMovieApiTests(TestCase):
    ...
    def test_list_movies(self):
        ...
        actor1 = sample_actor()
        actor2 = sample_actor(first_name="Dmytro", last_name="Bondariev")
        movie1 = sample_movie()
    ...
    def test_movies_filtering_by_genres(self):
        genre1 = sample_genre()
        genre2 = sample_genre(name="comedy")
        ...
        movie3 = sample_movie(description="Movie with no genres")
    ...
    def test_movie_search_by_title(self):
        movie1 = sample_movie()
        movie2 = sample_movie(title="Test Title")
    ...
    def test_retrieve_movie_detail(self):
        ...
        movie_detail_url = detail_url(movie_id=movie.id)
    ...
    def test_restricted_to_create_movie(self):
        payload = {
            "title": "Sample movie",
            "description": "Sample description",
            "duration": 90,
...
class AdminMovieApiTests(TestCase):
    def setUp(self) -> None:
        self.client = APIClient()
        self.user = get_user_model().objects.create_user(
            "admin@gmail.com", "testpassword12345", is_staff=True
        )
        self.client.force_authenticate(self.user)
    ...
    def test_create_movie(self):
        ...
        actor1 = sample_actor()
        actor2 = sample_actor(first_name="Dmytro", last_name="Bondariev")
        payload.update({"genres": [genre.id], "actors": [actor1.id, actor2.id]})
        ...
        self.assertEqual(list(movie.actors.all()), [actor1, actor2])
