...
class AuthenticatedMovieApiTests(TestCase):
    ...
    def test_filter_movies(self):
        genre = sample_genre(name="My genre")
        actor = sample_actor(first_name="My", last_name="Actor")

        movie1 = sample_movie(title="Movie with filter")
        movie2 = sample_movie(title="Movie without filter")
...
class AdminMovieApiTests(TestCase):
    ...
    def test_create_movie_with_filters_allowed(self):
        genre = sample_genre(name="My genre")
        actor = sample_actor(first_name="My", last_name="Actor")
