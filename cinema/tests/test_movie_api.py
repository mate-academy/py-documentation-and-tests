...
class MovieImageUploadTests(TestCase):
    ...
    class AuthenticatedMovieApiTests(TestCase):
        ...
        def test_filter_movies_by_genres_actors(self):
            ...
            movie3 = sample_movie(title="Movie without genre and actors")
            res = self.client.get(
                MOVIE_URL,
                {
                    "genres": f"{genre.id}",
            ...
            serializer_movie_3 = MovieListSerializer(movie3)
    ...
    class AdminMovieApiTests(TestCase):
        ...
        def test_create_movie_with_actors_genres(self):
            genre1 = sample_genre(name="Dawn")
            genre2 = sample_genre(name="Squawk")
            actor1 = sample_actor()
            actor2 = sample_actor()
