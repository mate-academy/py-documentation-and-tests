...
class AuthenticatedMovieApiTests(TestCase):
    ...
    def test_list_movie(self):
        ...
        sample_movie(title="movie_with_genre").genres.add(sample_genre())
        sample_movie(title="movie_with_actor").actors.add(sample_actor())
    ...
    def test_movies_filters(self):
        ...
        res1 = self.client.get(MOVIE_URL, {"title": "movie"})
