...
class AuthenticatedMovieApiTests(TestCase):
    def setUp(self):
        ...
        self.genre = sample_genre()
        self.movie_session = sample_movie_session(movie=self.movie)
        self.serializer = MovieListSerializer(self.movie)

    def test_list_movie(self):
        sample_movie()
        movie_with_all_fields = sample_movie()
        movie_with_all_fields.genres.add(self.genre)
        movie_with_all_fields.actors.add(self.actor)
        movie_with_all_fields.moviesession_set.add(self.movie_session)
    ...
    def test_filter_movies_by_title(self):
        movie = sample_movie(title="Test Title 1")
    ...
    def test_filter_movies_by_genre(self):
        ...
        self.assertIn(self.serializer.data, res.data)
