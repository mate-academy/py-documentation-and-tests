...
class AuthenticatedMovieApiTests(TestCase):
    ...
    def test_filter_movies(self):
        ...
        movie3 = sample_movie(title="Test without genre and actor")
        genre = sample_genre()
        actor = sample_actor()
        ...
        self.assertNotIn(serializer1.data, res3.data)
...
class AdminMovieApiTests(TestCase):
    ...
    def test_create_movie_with_genres_and_actors(self):
        ...
        actor1 = sample_actor()
        actor2 = sample_actor(first_name="Test", last_name="Testson")
        payload = {
            "title": "Movie Test",
            "description": "Test description",
            "duration": 100,
