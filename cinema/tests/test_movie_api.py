...
class AuthenticatedMovieApiTests(TestCase):
    ...
    def test_filter_movie_by_title(self):
        movie1 = sample_movie(title="Movie search")
        movie2 = sample_movie(title="Movie 2")

        res = self.client.get(MOVIE_URL, {"title": "search"})
    ...
    def test_actors_movie(self):
        sample_movie()
        sample_movie_with_actors = sample_movie()

        actor1 = sample_actor(first_name="Coil", last_name="Bullet")
        actor2 = sample_actor(first_name="Mayke", last_name="Bullet")

        sample_movie_with_actors.actors.add(actor1, actor2)
    ...
    def test_genres_movie(self):
        ...
        sample_movie_with_genres.genres.add(genre1, genre2)
...
class AdminMovieApiTests(TestCase):
    ...
    def test_create_room_with_genre(self):
    ...
    def test_create_room_with_actors(self):
        actor1 = Actor.objects.create(first_name="Albert", last_name="White")
        actor2 = Actor.objects.create(first_name="Jonny", last_name="Dap")
