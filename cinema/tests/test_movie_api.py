...
class AuthenticatedMovieApiTests(TestCase):
    ...
    def test_list_movies(self):
        ...
        actor1 = sample_actor(first_name="First Test")
        actor2 = sample_actor(first_name="Second Test")
    ...
    def test_filter_movie_by_title(self):
        movie1 = sample_movie(title="Qwer")
        movie2 = sample_movie(title="qWrt")
        movie3 = sample_movie(title="qwEr")

        res = self.client.get(MOVIE_URL, {"title": "qwe"})
...
class AdminMovieApiTests(TestCase):
    def setUp(self):
        ...
        self.admin_user = get_user_model().objects.create_user(
            email="admin@cinema.com", password="2qazcde4", is_staff=True
        )
    ...
    def test_create_movie(self):
        ...
        response = self.client.post(MOVIE_URL, main_data)
