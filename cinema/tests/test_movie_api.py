...
class MovieAuthenticatedTests(TestCase):
    ...
    def test_list_movies(self):
        sample_movie()
        movie_with_extra_params = sample_movie()

        actor = sample_actor()
        genre = sample_genre()

        movie_with_extra_params.actors.add(actor)
        movie_with_extra_params.genres.add(genre)
    ...
    def test_movie_filter_by_genre(self):
        movie1 = sample_movie(description="movie 1")
        movie2 = sample_movie(description="movie 2")
    ...
    def test_movie_filter_by_actors(self):
        ...
        actor1 = sample_actor()
        actor2 = sample_actor(first_name="George", last_name="Clooney")
