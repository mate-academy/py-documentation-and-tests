...
class AuthenticatedMovieApiTests(TestCase):
    def setUp(self):
        self.client = APIClient()
        self.user = get_user_model().objects.create_user("test@test.com", "test12345")
    ...
    def test_filter_movies_by_actor(self):
        ...
        actor1 = sample_actor()
        actor2 = sample_actor(last_name="test2")
        actor3 = sample_actor(last_name="test3")

        movie1.actors.add(actor1, actor2)
        movie2.actors.add(actor1, actor3)
        movie3.actors.add(actor2, actor3)
    ...
    def test_create_forbidden(self):
        payload = {"title": "testname", "duration": 90}
...
class AdminMovieApiTests(TestCase):
    def setUp(self):
        ...
        self.user = get_user_model().objects.create_user(
            "admin@admin.com", "test12345", is_staff=True
        )
        self.client.force_authenticate(self.user)
