...
class AuthenticatedBusApiTests(TestCase):
    ...
    def test_movies_list(self):
        ...
        serializer = MovieListSerializer(buses, many=True)
    ...
    def test_filter_movies_by_title(self):
        ...
        movie_2 = sample_movie(title="Test movie")
        ...
        serializer_test_movie = MovieListSerializer(movie_2)

        self.assertEqual(res.status_code, status.HTTP_200_OK)
        self.assertEqual(len(res.data["results"]), 1)
        self.assertEqual(res.data["results"][0], serializer_test_movie.data)
        self.assertEqual(res.data["results"][0]["title"], "Test movie")

    def test_filter_movies_by_actors(self):
        movie = sample_movie()
        movie_with_actor_1 = sample_movie(title="Test_1")
        movie_with_actor_2 = sample_movie(title="Test_2")
