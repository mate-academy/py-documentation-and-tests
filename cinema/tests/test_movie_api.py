...
class AuthenticatedMovieApiTest(TestCase):
    ...
    def test_movie_filter_by_title(self):
        movie1 = sample_movie(title="Testik1")
        movie2 = sample_movie(title="Testik2")
        movie3 = sample_movie(title="Test3")

        res = self.client.get(MOVIE_URL, {"title": "Testik"})
    ...
    def test_movie_filter_by_actors(self):
        ...
        actor1 = sample_actor(first_name="George1", last_name="Clooney1")
        actor2 = sample_actor(first_name="George2", last_name="Clooney2")
