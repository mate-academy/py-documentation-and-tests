...
class AuthenticatedMovieApiViewTests(TestCase):
    ...
    def test_filter_movies_by_genre_id(self):  # TODO: Add filter by title&actor!
...
class AdminMovieApiViewTests(TestCase):
    ...
    def test_create_new_movie_with_genres_and_actors(self):
        genre1 = sample_genre(name="Drama")
        genre2 = sample_genre(name="Comedy")

        actor1 = sample_actor(first_name="Leo")
        actor2 = sample_actor(first_name="Keanu")
