...
class AuthenticatedCinemaApiTests(TestCase):
    ...
    def test_list_movies(self):
        ...
        actor = Actor.objects.create(first_name="Actor1", last_name="Testovich")
        genre = Genre.objects.create(name="Testiller")
    ...
    def test_retrieve_movie_detail(self):
        ...
        actor = sample_actor(first_name="Actor2", last_name="Actor2")
