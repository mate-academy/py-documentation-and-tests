...
class AuthenticatedBusApiTests(TestCase):
    ...
    def test_filter_movies_by_title(self):
        movie1 = sample_movie(title="Terminator")
        movie2 = sample_movie(title="The Independents' Day")
        movie3 = sample_movie(title="Matrix")

        res = self.client.get(MOVIE_URL, {"title": "Termi"})
    ...
    def test_retrieve_movie_detail(self):
        movie = sample_movie(title="Movie_retrieve")
