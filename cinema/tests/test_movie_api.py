...
class UnauthenticatedMoveApiTests(TestCase):
    def setUp(self):
        self.client = APIClient()
...
class AuthenticatedMoveApiTests(TestCase):
    def setUp(self):
        self.client = APIClient()
    ...
    def test_filter_movies_by_actors(self):
        ...
        actor1 = Actor.objects.create(first_name="test1", last_name="test11")
        actor2 = Actor.objects.create(first_name="test2", last_name="test22")
    ...
    def test_create_movie_forbidden(self):
        payload = {"title": "Test", "duration": 100}
...
class AdminMovieApiTests(TestCase):
    ...
    def test_create_movie(self):
        ...
        for key in payload:
            if key == "genres":
                self.assertEqual(genre, getattr(movie, key).get(id=genre.id))
            elif key == "actors":
                self.assertEqual(actor, getattr(movie, key).get(id=actor.id))
            else:
