...
class AuthenticatedMovieApi(TestCase):
    ...
    def test_movies_by_actors(self):
        ...
        actor1 = sample_actor(first_name="Valera", last_name="Sheva")
        actor2 = sample_actor(first_name="Victor", last_name="Test")
    ...
    def test_retrieve_movie_detail(self):
        ...
        movie.actors.add(Actor.objects.create(first_name="Oleg", last_name="Popov"))
