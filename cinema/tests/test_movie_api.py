...
class AuthenticatedMovieApiTests(TestCase):
    ...
    def test_filter_movies_by_actors(self):
        ...
        actor1 = sample_actor(first_name="TestName1", last_name="TestSurname1")
        actor2 = sample_actor(first_name="TestName2", last_name="TestSurname2")
...
class AdminMovieApiTests(TestCase):
    ...
    def test_movie_delete_not_allowed(self):
        url = detail_url(movie_id=sample_movie().id)
