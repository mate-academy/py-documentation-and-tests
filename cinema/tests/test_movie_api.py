...
class AuthenticatedMovieAPITests(TestCase):
    ...
    def test_movies_list(self):
        ...
        actor_2 = sample_actor(first_name="Test",
                               last_name="Test")
    ...
    def test_filter_movies_by_title(self):
        ...
        movie_specific_1 = sample_movie(title="The Great Adventure")
        movie_specific_2 = sample_movie(title="Adventure in the Wild")

        movie_unmatched = sample_movie(title="Romantic Comedy")

        filter_title = "Adventure"
        res = self.client.get(MOVIE_URL, {"title": filter_title})

        serializer_specific_1 = MovieListSerializer(movie_specific_1)
        serializer_specific_2 = MovieListSerializer(movie_specific_2)
        serializer_default = MovieListSerializer(movie_default)
        serializer_unmatched = MovieListSerializer(movie_unmatched)

        self.assertIn(serializer_specific_1.data, res.data)
        self.assertIn(serializer_specific_2.data, res.data)

        self.assertNotIn(serializer_default.data, res.data)
        self.assertNotIn(serializer_unmatched.data, res.data)
    ...
    def test_create_movie_forbidden(self):
        payload = {
            ...
            "description": "The Great Adventure in the Wild",
            "duration": 90,
        }
