...
class AuthenticatedCinemaApiTests(TestCase):
    ...
    def test_filter_movies_by_actors(self):
        movie1 = sample_movie()
        movie2 = sample_movie(title="Fifth element")

        actor1 = sample_actor()
        actor2 = sample_actor(first_name="Milla")
...
class AdminMovieApiTests(TestCase):
    ...
    def test_create_movie(self):
        payload = {
            "title": "Interstellar",
            "description": "Time and space are incredible",
            "duration": 175,
        }
    ...
    def test_create_movie_with_genre_and_actor(self):
        ...
        self.assertEqual(res.status_code, status.HTTP_201_CREATED)
        self.assertEqual([genres.count(), actors.count()], [2, 2])
        self.assertEqual(list(genres), [genre1, genre2])
        self.assertEqual(list(actors), [actor1, actor2])
