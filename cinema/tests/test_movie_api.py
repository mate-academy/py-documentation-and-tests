...
class AuthenticatedMovieApiTests(TestCase):
    ...
    def test_filter_movies_by_title(self):
        ...
        res = self.client.get(MOVIE_URL, {"movies": f"{movie1.title}, {movie2.title}"})
    ...
    def test_filter_movies_by_genres(self):
        ...
        res = self.client.get(MOVIE_URL, {"movies": f"{genre1.id}, {genre2.id}"})
    ...
    def test_filter_movies_by_actors(self):
        ...
        res = self.client.get(MOVIE_URL, {"movies": f"{actor1.id}, {actor2.id}"})
