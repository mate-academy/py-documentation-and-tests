...
class AuthenticatedMovieApiTest(TestCase):
    ...
    def test_filter_movie_by_actors_ids(self):
        movie_1 = sample_movie()
        movie_2 = sample_movie()

        actor_1 = sample_actor(first_name="Ostap", last_name="Stupka")
        actor_2 = sample_actor(first_name="Stepan", last_name="Band")
    ...
    def test_filter_movie_by_genres_ids(self):
        movie_1 = sample_movie()
        movie_2 = sample_movie()
    ...
    def test_retrieve_movie_detail(self):
        ...
        actor = sample_actor(first_name="Ostap", last_name="Stupka")
