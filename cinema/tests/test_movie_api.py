...
class AuthenticatedMovieApiTests(TestCase):
    ...
    def test_list_movie(self):
        ...
        actor1 = sample_actor(first_name="Actor Test")
        actor2 = sample_actor(first_name="Actor Testenko")
    ...
    def test_filter_movies_by_genres(self):
        ...
        genre1 = sample_genre(name="Test Genre 1")
        genre2 = sample_genre(name="Test Genre 2")
