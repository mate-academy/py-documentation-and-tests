...
class AuthenticatedMovieAPITests(TestCase):
    ...
    def test_list_with_genres_filtering(self):
        ...
        res2 = self.client.get(MOVIE_URL, {"genres": "69"})
        self.assertEqual(len(res2.data), 0)

    def test_list_with_actors_filtering(self):
        movie1 = sample_movie(title="Movie 1")
        movie2 = sample_movie(title="Movie 2")
        ...
        res2 = self.client.get(MOVIE_URL, {"actors": "420"})
        self.assertEqual(len(res2.data), 0)

    def test_list_with_title_filtering(self):
        ...
        res2 = self.client.get(MOVIE_URL, {"title": "Shrek"})
        self.assertEqual(len(res2.data), 0)
    ...
    def test_retrieve_invalid_movie_detail(self):
        url = detail_url(999)
        res = self.client.get(url)
