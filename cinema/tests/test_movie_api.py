...
class AuthenticatedMovieApiTests(TestCase):
    ...
    def test_filter_movies(self):
        ...
        actor2 = sample_actor(first_name="Bill", last_name="Adamson")
        ...
        res1 = self.client.get(MOVIE_URL, {"genres": f"{genre1.id}", f"actors": f"{actor1.id}"})
        res2 = self.client.get(MOVIE_URL, {"genres": f"{genre2.id}", f"actors": f"{actor2.id}"})
        res3 = self.client.get(MOVIE_URL, {"genres": f"{genre1.id},{genre2.id}", f"actors": f"{actor1.id},{actor2.id}"})
...
class AdminMovieTest(TestCase):
    ...
    def test_create_movies(self):
        ...
        self.assertEqual(genres.count(), len(genres))
        self.assertEqual(actors.count(), len(actors))
    ...
    def test_patch_movie_not_allowed(self):
        ...
        res = self.client.patch(url, {"title": "Movie patch"})
