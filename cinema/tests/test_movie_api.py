...
class AuthenticatedMovieApiTests(TestCase):
    ...
    def test_movie_list(self):
        ...
        genre_1 = Genre.objects.create(name="Boliwood")
        genre_2 = Genre.objects.create(name="Boliwood_comedy")
    ...
    def test_movies_by_genre(self):
        ...
        serializer_no_genre = MovieListSerializer(movie_no_genre)
    ...
    def test_retrieve_movie_detail(self) -> None:
        movie = sample_movie()
        movie.genres.add(Genre.objects.create(name="Boliwood"))
