...
class AuthenticatedMovieApiTest(TestCase):
    ...
    def test_movies_list_with_filtration(self):
        movie_with_minimal_info = sample_movie()
        serializer_empty_movie = MovieListSerializer(movie_with_minimal_info)

        movie_with_another_title = sample_movie(title="Test movie")
        serializer_with_title = MovieListSerializer(movie_with_another_title)
