...
class AuthenticatedMovieApiTests(TestCase):
    def setUp(self):
        ...
        self.user = get_user_model().objects.create_user(
            email="test@test.com", password="Pass12345"
        )
        self.client.force_authenticate(self.user)
    ...
    def test_filter_movies_by_genres_actor_title(self):
        movie1 = sample_movie(title="Movie without genres and actors")
        movie2 = sample_movie(title="Movie with genre")
        movie3 = sample_movie(title="Movie with actors")
        ...
        res1 = self.client.get(MOVIE_URL, {"title": str(movie1.title)})
        res2 = self.client.get(MOVIE_URL, {"genres": str(genre.id)})
        res3 = self.client.get(MOVIE_URL, {"actors": str(actor.id)})
