...
class AuthenticatedMovieApiTests(TestCase):
    ...
    def test_filter_movie_by_genres(self):
        ...
        genre1 = Genre.objects.create(name="Commedia")
    ...
    def test_filter_movie_by_actors(self):
        new_movie1 = sample_movie(title="Movie_test")
        new_movie2 = sample_movie(title="Movie_test2")
        new_movie3 = sample_movie(title="Movie without actor")

        actor1 = sample_actor()

        new_movie1.actors.add(actor1)
        new_movie2.actors.add(actor1)

        res = self.client.get(MOVIE_URL, {"actors": f"{actor1.id}"})

        serializer1 = MovieListSerializer(new_movie1)
        serializer2 = MovieListSerializer(new_movie2)
        serializer3 = MovieListSerializer(new_movie3)
    ...
    def test_create_movie_forbidden(self):
        new_movie = {
            "title": "John Wick",
            "description": "John Wick the witch",
            "duration": 125
        }

        res = self.client.post(MOVIE_URL, new_movie)
...
class AdminMovieApiTests(TestCase):
    ...
    def test_create_movie(self):
        new_movie = {
            "title": "John Villas",
            "description": "John Villas the witch",
            "duration": 135
        }
