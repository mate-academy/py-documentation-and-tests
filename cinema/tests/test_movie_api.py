...
class AuthenticatedMovieApiTests(TestCase):
    ...
    def test_list_movie(self):
        ...
        actor = sample_actor(first_name="Testing", last_name="test")
        genre = sample_genre(name="test_genre")
    ...
    def test_filter_movies_by_actors(self):
        ...
        actor1 = sample_actor(first_name="Testing1", last_name="test")
        actor2 = sample_actor(first_name="Testing2", last_name="test")
    ...
    def test_retrieve_movie_info(self):
        movie1 = sample_movie(title="movie1")
        actor1 = sample_actor(first_name="Testing1", last_name="test")
        genre1 = sample_genre(name="test_name1")
        ...
        url = detail_url(movie_id=movie1.id)
        result = self.client.get(url)

        serializer1 = MovieDetailSerializer(movie1)

        self.assertEqual(result.status_code, status.HTTP_200_OK)
        self.assertEqual(result.data, serializer1.data)
...
class AdmiinMovieApiTests(TestCase):
    def setUp(self) -> None:
        self.client = APIClient()
        self.user = get_user_model().objects.create_user(
