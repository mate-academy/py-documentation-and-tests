...
class AuthenticatedMovieApiTests(TestCase):
    ...
    def test_filter_movies_by_actors(self):
        ...
        actor_1 = sample_actor(first_name="Leonardo", last_name="Di Caprio")
        actor_2 = sample_actor(first_name="Johny", last_name="Sins")
    ...
    def test_filter_movies_by_title(self):
        movie_1 = sample_movie(title="Interstellar")
        movie_2 = sample_movie(title="Sherlock Holmes")

        result = self.client.get(
            MOVIE_URL, {"title": "Interstellar"}
        )
...
class AdminMovieTests(TestCase):
    ...
    def test_create_movie(self):
        ...
        result = self.client.post(MOVIE_URL, payload, format="json")
