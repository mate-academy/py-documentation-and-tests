...
class AuthenticatedMovieApiTests(TestCase):
    ...
    def test_list_movies(self):
        ...
        actor1 = sample_actor(first_name="test", last_name="test_test")
        actor2 = sample_actor(first_name="value", last_name="value_value")
    ...
    def test_filter_movies_by_actors(self):
        ...
        actor2 = sample_actor(first_name="Bob", last_name="Thornton")
