...
class AuthenticatedMovieApiTests(TestCase):
    ...
    def test_filter_movies_by_actors(self):
        ...
        movie_with_out_actors = sample_movie(title="Movie With Out Actors")

        res = self.client.get(MOVIE_URL, {"actors": f"{actor1.id},{actor2.id}"})

        serializer1 = MovieListSerializer(movie1)
        serializer2 = MovieListSerializer(movie2)
        serializer3 = MovieListSerializer(movie_with_out_actors)
    ...
    def test_filter_movies_by_genres(self):
        ...
        movie_with_out_genres = sample_movie(title="Movie With Out Genres")
        ...
        serializer1 = MovieListSerializer(movie1)
        serializer2 = MovieListSerializer(movie2)
        serializer3 = MovieListSerializer(movie_with_out_genres)
