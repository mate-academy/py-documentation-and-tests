...
class AuthenticatedMovieAPITests(TestCase):
    ...
    def test_filter_movies_by_title(self):
        ...
        movie_3 = sample_movie(title="TestTest")
    ...
    def test_filter_movies_by_genres(self):
        ...
        movie_with_genre_1 = sample_movie(title="Test")
        movie_with_genre_2 = sample_movie(title="TestTest")

        genre_1 = sample_genre(name="Test")
        genre_2 = sample_genre(name="TestTest")
    ...
    def test_filter_movies_by_actors(self):
        ...
        movie_with_actor_1 = sample_movie(title="Test")
        movie_with_actor_2 = sample_movie(title="TestTest")

        actor_1 = sample_actor(first_name="Test")
        actor_2 = sample_actor(first_name="TestTest")
...
class AdminMovieAPITests(TestCase):
    def setUp(self):
        self.client = APIClient()
        self.user = get_user_model().objects.create_user(
            email="admin@test.case", password="test123password", is_staff=True,
        )
        self.client.force_authenticate(self.user)
