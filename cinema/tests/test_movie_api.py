...
class AuthenticatedMovieApiTests(TestCase):
    ...
    def test_list_movies(self):
        ...
        genres1 = Genre.objects.create(name="Action")
        genres2 = Genre.objects.create(name="Comedy")

        movie_with_genre.genres.add(genres1, genres2)
    ...
    def test_filter_movie_by_genres(self):
        ...
        actor1 = Actor.objects.create(first_name="John", last_name="Wick")
        actor2 = Actor.objects.create(first_name="Cris", last_name="Prat")

        movie1.genres.add(genres1), movie1.actors.add(actor1)
        movie2.genres.add(genres2), movie2.actors.add(actor2)
...
class AdminMovieApiTests(TestCase):
    ...
    def test_create_movie_with_genre_and_actors(self):
        genre1 = Genre.objects.create(name="Actions")
