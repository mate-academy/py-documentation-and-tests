...
class AuthenticatedMovieApiTests(TestCase):
    def setUp(self):
        ...
        self.user = get_user_model().objects.create_user(
            email="testuser@mail.com", password="1qazcde3"
        )
        self.client.force_authenticate(self.user)
    ...
    def test_filter_movies_by_title(self):
        ...
        self.assertNotIn(serializer_1, res.data)

    def test_movie_by_genres(self):
        movie_1 = sample_movie()
        movie_2 = sample_movie(title="movie2")
        movie_3 = sample_movie(title="movie3")
...
class AdminMovieTests(TestCase):
    def setUp(self):
        self.client = APIClient()
        self.user = get_user_model().objects.create_user(
            email="admin@mail.com", password="1qazcde3", is_staff=True
        )
        self.client.force_authenticate(self.user)
