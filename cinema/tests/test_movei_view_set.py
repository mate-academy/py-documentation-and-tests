...
class AuthenticatedMovieApiTests(TestCase):
    ...
    def test_filter_movies_by_actor(self):
        ...
        self.assertIn(
            serializer_with_actor_one.data, response_filter_title.data
        )
        self.assertIn(
            serializer_with_actor_two.data, response_filter_title.data
        )
    ...
    def test_filter_movies_by_genre(self):
        ...
        self.assertIn(
            serializer_with_genre_one.data, response_filter_title.data
        )
        self.assertIn(
            serializer_with_genre_two.data, response_filter_title.data
        )
        self.assertNotIn(serializer.data, response_filter_title.data)
