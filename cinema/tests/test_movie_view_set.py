...
def some_movie(**params):
    defaults = {
        ...
        "description": "Good western movie",
        "duration": 3
    }
...
class AuthenticatedMovieTests(TestCase):
    ...
    def test_list_movies(self):
        ...
        genre1 = Genre.objects.create(name="western")
        genre2 = Genre.objects.create(name="action")

        actor1 = Actor.objects.create(first_name="Jamie", last_name="Foxx")
        actor2 = Actor.objects.create(first_name="Christoph", last_name="Waltz")
    ...
    def test_movie_filter(self):
        movie_empty = some_movie()
        movie1 = some_movie()
        movie2 = some_movie()

        genre = Genre.objects.create(name="western")
        ...
        serializer1 = MovieListSerializer(movie_empty)
