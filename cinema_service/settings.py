...
INSTALLED_APPS = [
    ...
    "debug_toolbar",
    "cinema", "user", 'rest_framework_swagger', 'rest_framework_simplejwt', 'drf_spectacular'
]
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'show tickets,seats',
    'VERSION': '1.0.0',
...
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(minutes=90000),
