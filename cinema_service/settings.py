...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "The Cinema Ticket Booking API provides functionality for "
    "managing cinema halls, movies, genres, actors, movie sessions, "
    "orders, and tickets. It allows users to browse available cinema "
    "halls, view movie details, book tickets for movie sessions, "
    "and place orders.",
    "VERSION": "1.0.0",
