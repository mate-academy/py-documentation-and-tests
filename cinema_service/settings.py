...
SPECTACULAR_SETTINGS = {
    "TITLE": "Cinema App Project API",
    "DESCRIPTION": "Order tickets for your cinema sessions",
    "VERSION": "1.0.0",
...
SIMPLE_JWT = {
    ...
    "REFRESH_TOKEN_LIFETIME": timedelta(days=7),  # default one day
    "ROTATE_REFRESH_TOKEN": True  # refresh refresh-token
